        ...
        <div class="w3-main" style="margin-left:300px">
            ...
            <header class="w3-container" id="portfolio">
                ...
                <div class="w3-section w3-bottombar w3-padding-16">
                    ...
                    <li><g:link class="w3-button w3-white" action="showStandings" params="[conferenceIndex: '1']">Western Conference</g:link></li>
                    <li><g:link class="w3-button w3-white" action="showStandings" params="[conferenceIndex: '2']">Eastern Conference</g:link></li>
                </div>
            </header>
