    ...
    <body>
        ...
        <div>
            <div class="row">
                <div class="nav" role="navigation">
                    <ul>
                        <li><g:link action="season" params="[conferenceIndex: '1']">Western Conference</g:link></li>
                        <li><g:link action="season" params="[conferenceIndex: '2']">Eastern Conference</g:link></li>
                    </ul>
                </div>
