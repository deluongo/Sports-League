...
<div class="w3-container w3-padding w3-margin">
    <div class="comment-form">
        ...
        <g:form class="new-comment-form" name="new-comment-form" action="submitComment" id="${currentUser.id}-on-${post.id}-${post.numComments}">
            ...
            <g:actionSubmit class="w3-btn w3-black w3-padding w3-margin remove-padding-b remove-margin-b w3-hover-red new-comment-submit" align="right" name="submitComment" action="submitComment" value="Send Comment" />
