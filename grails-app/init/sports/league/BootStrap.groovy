...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        savePlayer(saveUser("kevindurant", "kevindurant", "Kevin Wayne Durant (born September 29, 1988) is an American professional basketball player for the Golden State Warriors of the National Basketball Association (NBA). Durant has won an NBA Most Valuable Player Award, four NBA scoring titles, the NBA Rookie of the Year Award, and two Olympic gold medals. He has also been selected to six All-NBA teams and eight All-Star teams.\n" +
                "\n" +
        ...
        savePlayer(saveUser("draymongreen", "draymongreen", "Coming Soon!!!",
        ...
        savePlayer(saveUser("zazapachulia", "zazapachuilia", "Coming Soon!!!",
        ...
        saveCoach(saveUser("stevekerr", "stevekerr", "Coming Soon!!!",
        ...
        /* ___  ~cscie56.ps3.Person~ [starters]  ___ */
        savePlayer(saveUser("kawhileonard", "kawhileonard", "Coming Soon!!!",
        ...
        savePlayer(saveUser("lamarcusaldridge", "lamarcusaldridge", "Coming Soon!!!",
        ...
        savePlayer(saveUser("paugasol", "paugasol", "Coming Soon!!!",
        ...
        savePlayer(saveUser("manuginobili", "manuginobili", "Coming Soon!!!",
        ...
        savePlayer(saveUser("dannygreen", "dannygreen", "Coming Soon!!!",
        ...
        /* ___  ~cscie56.ps3.Person~ [coach]  ___ */
        saveCoach(saveUser("gregpopovich", "gregpopovich", "Coming Soon!!!",
     ...
     *  ========================= | ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
    def saveUser(username, password, bio, birthDate, birthPlace, height, weight, universityAttended, pictureURL) {
        /* ___  create player  ___ */
